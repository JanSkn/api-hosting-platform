...
public class MdcLogFilter implements ContainerRequestFilter, ContainerResponseFilter {
  ...
  public void filter(ContainerRequestContext requestContext) {
    String correlationId = requestContext.getHeaderString(LoggingConfig.CORRELATION_ID_HEADER);
  ...
  public void filter(
    ...
    if (correlationId != null) {
      responseContext.getHeaders().add(LoggingConfig.CORRELATION_ID_HEADER, correlationId);
    }
    LoggingConfig.clear();
  }
}
