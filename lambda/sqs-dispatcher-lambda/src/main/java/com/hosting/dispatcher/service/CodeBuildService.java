...
public class CodeBuildService {
  ...
  public CodeBuildService(CodeBuildClient codeBuildClient, DeploymentService deploymentService) {
    this.codeBuildRepository = new CodeBuildRepository(codeBuildClient);
    this.deploymentService = deploymentService;
  }

  public void startBuild(BuildMessage buildMessage) {
    String imageTag = codeBuildRepository.generateImageTag(buildMessage.userId(), buildMessage.deploymentId());
